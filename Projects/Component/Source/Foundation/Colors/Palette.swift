...
public struct LegacyPalette : Sendable {
    public init() {}
    ...
    //MARK: Sementic
    //MARK: blue
    public let blueNormal = Color(0x62839E)
    public let blueAlternative = Color(0x647685)
    public let blueNetural = Color(0x5B96C7)
    
    //MARK: purple
    public let purpleNormal = Color(0xA980CF)
    public let purpleAlternative = Color(0x7D6D8C)
    public let purpleNetural = Color(0xA980CF)
    
    //MARK: green
    public let greenNormal = Color(0x508050)
    public let greenAlternative = Color(0x677867)
    
    //MARK: red
    public let redNormal = Color(0xD05458)
    public let redAlternative = Color(0x6E4344)
    public let redNetural = Color(0xF06969)
...
private let P = LegacyPalette.shared

@available(macOS 12, iOS 15, *)
private let commons = [P.common0, P.common100]
...
@available(macOS 12, iOS 15, *)
private let blues = [
    P.blue10, P.blue20, P.blue30, P.blue40, P.blue45,
    P.blue50, P.blue60, P.blue70, P.blue80, P.blue90,
    P.blue95, P.blue99
]

@available(macOS 12, iOS 15, *)
private let reds = [
    P.red10, P.red20, P.red30, P.red40, P.red50,
    P.red60, P.red70, P.red80, P.red90, P.red95, P.red99
]

@available(macOS 12, iOS 15, *)
private let greens = [
    P.green10, P.green20, P.green30, P.green40, P.green50,
    P.green60, P.green70, P.green80, P.green90, P.green95, P.green99
]

@available(macOS 12, iOS 15, *)
private let yellows = [
    P.yellow10, P.yellow20, P.yellow30, P.yellow40, P.yellow50,
    P.yellow60, P.yellow70, P.yellow80, P.yellow90, P.yellow95, P.yellow99
]

@available(macOS 12, iOS 15, *)
private let sementic = [
    P.blueNormal, P.blueAlternative, P.blueNetural,
    P.redNormal, P.redAlternative, P.redNetural,
    P.yellowNormal, P.yellowAlternative, P.yellowNetural,
    P.purpleNormal, P.purpleAlternative, P.purpleNetural,
    P.greenNormal, P.greenAlternative
]

@available(macOS 12, iOS 15, *)
private func colorPreview(_ colors: [Color]) -> some View {
    VStack(spacing: 0) {
...
#Preview {
    VStack(spacing: 0) {
        colorPreview(commons)
        colorPreview(neutrals)
        colorPreview(blues)
        colorPreview(reds)
        colorPreview(greens)
        colorPreview(yellows)
        colorPreview(sementic)
    }
}
